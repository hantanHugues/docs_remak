...
import { Code, Navigation, Gamepad2, Monitor, ArrowRight, BookOpen, Target, Clock } from "lucide-react"
      ...
      },
      {
        ...
        items: [
          ...
          },
          {
            ...
            items: [
              { title: "Présentation", href: "/docs/semaine-3/it" },
...
const sections = [
  {
    title: "Introduction",
    description: "Introduction aux concepts avancés de robotique et algorithmique",
    href: "/docs/semaine-3/it/introduction",
    icon: BookOpen,
    difficulty: "Avancé",
    duration: "1h",
  ...
  },
  {
    ...
    description: "Maîtriser les algorithmes de recherche de chemin pour navigation autonome",
    href: "/docs/semaine-3/it/algorithme-pathfinding",
    icon: Navigation,
    difficulty: "Avancé",
    duration: "3h",
  ...
  {
    title: "Algorithme de cartographie Nav2",
    description: "Algorithmes avancés de cartographie et navigation avec Nav2",
    href: "/docs/semaine-3/it/algorithme-cartographie-nav2",
    icon: Code,
    difficulty: "Avancé",
    duration: "3.5h",
...
export default function ITS3Page() {
  return (
              ...
              <div className="container mx-auto px-4">
                <div className="max-w-4xl mx-auto text-center space-y-6">
                  ...
                  <h1 className="text-4xl md:text-6xl font-bold text-foreground">
                    IT <span className="text-purple-600">Avancé</span>
                  </h1>
                  
                  <p className="text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed">
                    Maîtrisez les technologies IT de pointe pour robotique. Pathfinding avancé, 
                    simulation Gazebo et visualisation RViz2.
                  </p>
                ...
                <div className="max-w-6xl mx-auto">
                  <div className="text-center mb-12">
                    ...
                    <p className="text-muted-foreground max-w-2xl mx-auto">
                      Explorez les technologies logicielles de pointe pour systèmes robotiques experts
                    </p>
                  </div>
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    <div className="space-y-4">
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          <h3 className="font-semibold mb-1">Navigation autonome avancée</h3>
                          <p className="text-sm text-muted-foreground">
                            Algorithmes de pathfinding optimaux et adaptatifs
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          <h3 className="font-semibold mb-1">Algorithmes complexes</h3>
                          <p className="text-sm text-muted-foreground">
                            Implémentation et optimisation d'A* et Dijkstra
                          </p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="space-y-4">
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          <h3 className="font-semibold mb-1">Simulation robotique</h3>
                          <p className="text-sm text-muted-foreground">
                            Maîtrise complète de Gazebo et intégration ROS2
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          <h3 className="font-semibold mb-1">Visualisation et debugging</h3>
                          <p className="text-sm text-muted-foreground">
                            Outils avancés RViz2 pour analyse et développement
                          </p>
                        </div>
                      </div>
                    </div>

...
import { Wrench, Settings, Printer, Calculator, ArrowRight, BookOpen, Target, Clock } from "lucide-react"
      ...
      },
      {
        ...
        items: [
          ...
          },
          {
            ...
            items: [
              { title: "Présentation", href: "/docs/semaine-3/mecanique" },
...
const sections = [
  {
    title: "Paramètres variables",
    description: "Conception paramétrique avancée et optimisation automatisée",
    href: "/docs/semaine-3/mecanique/parametres",
    icon: Settings,
    difficulty: "Avancé",
    duration: "3h",
  ...
  {
    title: "Impression 3D",
    description: "Fabrication additive pour prototypage et production robotique",
    href: "/docs/semaine-3/mecanique/3d",
    icon: Printer,
    difficulty: "Avancé",
    duration: "2.5h",
  ...
  },
  {
    ...
    description: "Analyse numérique avancée et simulation par éléments finis",
    href: "/docs/semaine-3/mecanique/calculs",
    icon: Calculator,
    difficulty: "Avancé",
    duration: "2h",
...
export default function MecaniqueS3Page() {
  return (
      ...
      <div className="flex pt-16 md:pt-20">
        ...
        <main className="flex-1 min-w-0">
          ...
          <AnimatedSection animation="fade-in">
            <section className="relative py-20 overflow-hidden bg-gradient-to-br from-green-50 via-white to-emerald-50 dark:from-green-950/20 dark:via-background dark:to-emerald-950/20">
              <div className="container mx-auto px-4">
                <div className="max-w-4xl mx-auto text-center space-y-6">
                  ...
                  <h1 className="text-4xl md:text-6xl font-bold text-foreground">
                    Mécanique <span className="text-green-600">Avancé</span>
                  </h1>
                  
                  <p className="text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed">
                    Maîtrisez la mécanique de pointe pour robotique. Conception paramétrique, 
                    fabrication additive et simulation numérique avancée.
                  </p>

                  <div className="flex flex-wrap items-center justify-center gap-4 pt-4">
                    <div className="flex items-center gap-2 text-sm text-muted-foreground">
                      <Clock className="w-4 h-4" />
                      <span>~7.5h de contenu</span>
                    </div>
                    <div className="flex items-center gap-2 text-sm text-muted-foreground">
                      <BookOpen className="w-4 h-4" />
                      <span>3 sections expertes</span>
                    </div>
                    <div className="flex items-center gap-2 text-sm text-muted-foreground">
                ...
                <div className="max-w-6xl mx-auto">
                  <div className="text-center mb-12">
                    ...
                    <p className="text-muted-foreground max-w-2xl mx-auto">
                      Explorez les technologies mécaniques de pointe pour systèmes robotiques experts
                    </p>
                  </div>
                          ...
                          <Card className="group hover:shadow-xl transition-all duration-300 border-2 hover:border-green-200 dark:hover:border-green-800">
                            ...
                            <CardContent className="pt-0">
                              ...
                              <Link href={section.href}>
                                <Button className="w-full group-hover:bg-green-600 group-hover:border-green-600 transition-colors">
                                  Commencer
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    <div className="space-y-4">
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          <h3 className="font-semibold mb-1">Conception paramétrique</h3>
                          <p className="text-sm text-muted-foreground">
                            Optimisation automatisée et génération de variantes
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          <h3 className="font-semibold mb-1">Fabrication additive</h3>
                          <p className="text-sm text-muted-foreground">
                            Technologies 3D pour prototypage et production robotique
                          </p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="space-y-4">
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          <h3 className="font-semibold mb-1">Simulation numérique</h3>
                          <p className="text-sm text-muted-foreground">
                            Analyse par éléments finis et validation de conception
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          <h3 className="font-semibold mb-1">Précision industrielle</h3>
                          <p className="text-sm text-muted-foreground">
                            Tolérances, ajustements et qualité de fabrication
                          </p>
                        </div>
                      </div>
                    </div>

...
import { Cpu, Zap, Wifi, ArrowRight, ArrowLeft, BookOpen, Target, Clock } from "lucide-react"
        ...
        items: [
          {
            ...
            items: [
              { title: "Présentation", href: "/docs/semaine-2/electronique" },
...
const sections = [
  {
    title: "Boîte Noire & Station de Contrôle",
    description: "Assemblage et configuration des modules BlackBox et Control Station",
    href: "/docs/semaine-2/electronique/boite-noire",
    icon: Cpu,
  ...
  {
    title: "Hardware",
    description: "Composants matériels utilisés - ATmega328P, MPU-6050, LCD I2C",
    href: "/docs/semaine-2/electronique/hardware",
    icon: Cpu,
    difficulty: "Intermédiaire",
    duration: "1.5h",
  ...
  },
  {
    ...
    description: "Code et firmware pour les modules Arduino",
    href: "/docs/semaine-2/electronique/software-firmware",
    icon: Zap,
    difficulty: "Intermédiaire",
    duration: "2h",
  ...
  {
    title: "Résultats & Démonstration",
    description: "Tests, performances et démonstrations du système",
    href: "/docs/semaine-2/electronique/results-demonstration",
    icon: Target,
    difficulty: "Intermédiaire",
    duration: "1h",
  ...
  },
  {
    ...
    description: "Suggestions d'améliorations et évolutions futures",
    href: "/docs/semaine-2/electronique/possible-improvements",
    icon: BookOpen,
    difficulty: "Avancé",
    duration: "0.5h",
  ...
  },
  {
    ...
    href: "/docs/semaine-2/electronique/troubleshooting",
    icon: Wifi,
    difficulty: "Intermédiaire",
    duration: "1h",
...
export default function ElectroniqueS2Page() {
  return (
              ...
              <div className="container mx-auto px-4">
                <div className="max-w-4xl mx-auto text-center space-y-6">
                  <Badge className="bg-blue-100 text-blue-700 border-blue-200 dark:bg-blue-900/50 dark:text-blue-300 dark:border-blue-800">
                    ...
                    Semaine 2 - Électronique
                  </Badge>
                  
                  <h1 className="text-4xl md:text-6xl font-bold text-foreground">
                    Électronique <span className="text-blue-600">Intermédiaire</span>
                  </h1>
                  
                  <p className="text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed">
                    Approfondissez vos connaissances en électronique robotique. Conception de PCB, 
                    systèmes complexes et communications avancées.
                  </p>

                  <div className="flex flex-wrap items-center justify-center gap-4 pt-4">
                    <div className="flex items-center gap-2 text-sm text-muted-foreground">
                      <Clock className="w-4 h-4" />
                      <span>~9h de contenu</span>
                    </div>
                    <div className="flex items-center gap-2 text-sm text-muted-foreground">
                      <BookOpen className="w-4 h-4" />
                      <span>3 sections avancées</span>
                    </div>
                    <div className="flex items-center gap-2 text-sm text-muted-foreground">
                ...
                <div className="max-w-6xl mx-auto">
                  <div className="text-center mb-12">
                    ...
                    <p className="text-muted-foreground max-w-2xl mx-auto">
                      Explorez des concepts avancés d'électronique pour systèmes robotiques complexes
                    </p>
                  </div>
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    <div className="space-y-4">
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          <h3 className="font-semibold mb-1">Analyse de systèmes complexes</h3>
                          <p className="text-sm text-muted-foreground">
                            Rétro-ingénierie et conception de boîtes noires électroniques
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          <h3 className="font-semibold mb-1">Conception de PCB</h3>
                          <p className="text-sm text-muted-foreground">
                            Routage, placement et optimisation de circuits imprimés
                          </p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="space-y-4">
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          <h3 className="font-semibold mb-1">Communications avancées</h3>
                          <p className="text-sm text-muted-foreground">
                            Protocoles I2C complexes et gestion d'erreurs
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          <h3 className="font-semibold mb-1">Intégration système</h3>
                          <p className="text-sm text-muted-foreground">
                            Assemblage et test de systèmes électroniques complets
                          </p>
                        </div>
                      </div>
                    </div>
